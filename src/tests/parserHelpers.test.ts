import { removeTheLetterYom, lettersDaysToFullDays, splitToDays, removeEverythingBeforeFriday, convertToActivityAndDay, fillInMissingDays } from 'components/AddUser/parser';
